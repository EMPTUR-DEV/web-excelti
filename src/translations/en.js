export const TRANSLATIONS_EN = {
    ...
    asesoramientoEnTraduccionContent: "To PCO´s, event planners, government, corporations, organizations and potential clients.  Manning and management of interpreters at congresses, conventions, seminars, training activities, negotiations, press conferences and other kinds of meetings in which participants of different languages and cultures require interpretation for communication purposes. Advice on other audiovisual services related to interpretation.",
    simultanea: "Simultaneous",
    simultaneaContent: "In standard simultaneous mode, the interpreter sits in a booth with a clear view of the meeting room and the speaker. He or she listens to and simultaneously interprets the speech into a target language. Standard simultaneous interpreting requires a booth (fixed or mobile)  as well as other the appropriate equipment (headphones, microphones).",
